...
public class PgQuerySplitResult {
    ...
    private static final long stmts$OFFSET = $LAYOUT.byteOffset(groupElement("stmts"));
    ...
    private static final long n_stmts$OFFSET = $LAYOUT.byteOffset(groupElement("n_stmts"));
